...
from nphm_tum.preprocessing.PIPNet.FaceBoxesV2.faceboxes_detector import *
from nphm_tum.preprocessing.PIPNet.lib.networks import *
from nphm_tum.preprocessing.PIPNet.lib.functions import *
from nphm_tum.preprocessing.PIPNet.lib.mobilenetv3 import mobilenetv3_large
...
def demo_image(images, net, preprocess, cfg, input_size, net_stride, num_nb, use_gpu, device):
	...
	my_thresh = 0.6
	det_box_scale = 1.2
	meanface_indices, reverse_index1, reverse_index2, max_len = get_meanface(os.path.join(snapshot_dir, 'data', cfg.data_name, 'meanface.txt'), cfg.num_nb)
...
def landmark_detection(images, bboxes, exp_path, device):
	...
	my_config = importlib.import_module(config_path, package='nphm_tum.preprocessing.PIPNet')
