...
def main(seq_name : str, intrinsics_provided : bool = False):
...
intrinsics_provided: {'true' if intrinsics_provided else 'false'}'''
    ...
    config_pth = f"{env_paths.CODE_BASE}/src/nphm_tum/preprocessing/metrical-tracker/configs/actors/{seq_name}.yml"
    ...
    os.system(f'cd {env_paths.CODE_BASE}/src/nphm_tum/preprocessing/metrical-tracker/; python tracker.py --cfg {config_pth}')
