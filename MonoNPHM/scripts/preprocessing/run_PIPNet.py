...
sys.path.append(f'{env_paths.CODE_BASE}/src/nphm_tum/preprocessing/PIPNet/FaceBoxesV2/')
from nphm_tum.preprocessing.pipnet_utils import face_detection, landmark_detection
...
def main_kinect(seq_name : str):
    ...
    for seq_tag in seq_tags:
        ...
        bboxes, confidences = face_detection(images, use_gpu=True, device='cuda', snapshot_dir=f'{env_paths.CODE_BASE}/src/nphm_tum/preprocessing/PIPNet/')
